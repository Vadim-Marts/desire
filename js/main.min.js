...
(()=>{const t=new Event("insideViewport"),e=new Event("outsideViewport"),n=document.documentElement.getAttribute("data-onscroll-effect-custom-prefix")||"scroll";let i=!1;const o=t=>"onscrollEffect_"+t,s=t=>void 0===t,r=()=>{const r=[...document.querySelectorAll(`[data-${n}]`)];if(!i&&0===r.length)return i=!0,console.warn(`onScroll Effect is not used: there's no element with 'data-${n}' attribute.`);i=!1,r.filter(t=>s(t[o("isRepeating")])||t[o("isRepeating")]).forEach(i=>{const r={className:i.dataset[n].split(" ").filter(Boolean),repeat:i.dataset[n+"Repeat"],offset:Number(i.dataset[n+"Offset"]),count:Number(i.dataset[n+"Count"]),reverse:i.dataset[n+"Reverse"]},a=i.getBoundingClientRect(),l="true"===r.reverse,c=r.className.length?r.className:[l?"is-inside":"is-outside"],d="true"===r.repeat,u=isNaN(r.offset)?0:r.offset,p=isNaN(Number(r.repeat))?1:Number(r.repeat),f=!c.filter(t=>!i.classList.contains(t)).length;return i[o("repeatingCount")]=s(i[o("repeatingCount")])?0:i[o("repeatingCount")],i[o("isRepeating")]=!!s(i[o("isRepeating")])||i[o("isRepeating")],(!l&&f||l&&!f)&&a.top+u<=window.innerHeight&&a.bottom-u>=0?(i.classList[l?"add":"remove"](...c),i[o("repeatingCount")]+=1,i[o("isInsideViewport")]=!0,i.dispatchEvent(t),!d&&i[o("repeatingCount")]>=p&&(i[o("isRepeating")]=!1),!0):(!l&&!f||l&&f)&&(0===i[o("repeatingCount")]||(d||i[o("repeatingCount")]<p)&&(a.top>window.innerHeight||a.bottom<0))?(i.classList[l?"remove":"add"](...c),i[o("isInsideViewport")]=!1,i.dispatchEvent(e),!1):void 0})},a=()=>{r(),"complete"===document.readyState&&document.removeEventListener("readystatechange",a)};document.addEventListener("readystatechange",a),window.addEventListener("scroll",((t,e,n)=>{let i;return function(){const e=arguments,n=this;clearTimeout(i),i=setTimeout(()=>{i=null,Reflect.apply(t,n,e)},10)}})(r),!0),window.onScrollEffect=Object.assign(()=>{r(),r()},{isRepeating:t=>t[o("isRepeating")],repeatingCount:t=>t[o("repeatingCount")],isInsideViewport:t=>t[o("isInsideViewport")]})})(),$((function(){$(".header__btn").on("click",(function(){$(".rightside-menu").removeClass("rightside-menu--close")})),$(".rightside-menu__close").on("click",(function(){$(".rightside-menu").addClass("rightside-menu--close")})),$(".header__btn-menu").on("click",(function(){$(".menu").toggleClass("menu--open")})),$(window).width()<651&&$(".works-path__item--measuring").appendTo($(".works-path__items-box")),$(".top__slider").slick({dots:!0,arrows:!1,fade:!0,autoplay:!0}),$(".contact-slider").slick({slidesToShow:10,slidesToScroll:10,dots:!0,arrows:!1,autoplay:!0,responsive:[{breakpoint:1700,settings:{slidesToShow:8,slidesToScroll:8}},{breakpoint:1511,settings:{slidesToShow:6,slidesToScroll:6}},{breakpoint:1201,settings:{slidesToShow:4,slidesToScroll:4}},{breakpoint:841,settings:{slidesToShow:3,slidesToScroll:3}},{breakpoint:551,settings:{slidesToShow:2,slidesToScroll:2}},{breakpoint:376,settings:{slidesToShow:1,slidesToScroll:1}}]}),$(".article-slider__box").slick({prevArrow:'<button type="button" class="article-slider__arrow article-slider__arrowleft"><img src="images/arrow-slide-left.svg" alt="arrow left"></button>',nextArrow:'<button type="button" class="article-slider__arrow article-slider__arrowright"><img src="images/arrow-slide-right.svg" alt="arrow right"></button>'});mixitup(".gallery__inner",{load:{filter:".living"}});AOS.init(),AOS.init({delay:450,duration:800})}));